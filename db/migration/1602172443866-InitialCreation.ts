...
export class InitialCreation1602172443866 implements MigrationInterface {
  name = 'InitialCreation1602172443866'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE `suspension` (`id` int NOT NULL AUTO_INCREMENT, `active` tinyint NOT NULL, `created_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `student_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB'
    )
    await queryRunner.query(
      'CREATE TABLE `teacher` (`id` int NOT NULL AUTO_INCREMENT, `uuid` varchar(36) NOT NULL, `first_name` varchar(32) NOT NULL, `last_name` varchar(32) NOT NULL, `email` varchar(64) NOT NULL, `created_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `IDX_1905b1ed1612ef0a96c77fb722` (`uuid`), UNIQUE INDEX `IDX_00634394dce7677d531749ed8e` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    )
    await queryRunner.query(
      'CREATE TABLE `teaches` (`id` int NOT NULL AUTO_INCREMENT, `created_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `teacher_id` int NULL, `student_id` int NULL, UNIQUE INDEX `IDX_12c94a3dcf2f0d1c707f5192ee` (`teacher_id`, `student_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    )
    await queryRunner.query(
      'CREATE TABLE `student` (`id` int NOT NULL AUTO_INCREMENT, `uuid` varchar(36) NOT NULL, `first_name` varchar(32) NOT NULL, `last_name` varchar(32) NOT NULL, `email` varchar(64) NOT NULL, `created_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_date` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `IDX_e11fbd60aaa3196597d36f2bbf` (`uuid`), UNIQUE INDEX `IDX_a56c051c91dbe1068ad683f536` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    )
    await queryRunner.query(
